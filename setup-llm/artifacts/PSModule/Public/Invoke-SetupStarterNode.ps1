function Invoke-SetupStarterNode {
    <#
    .SYNOPSIS
    Runs the discovered PowerShell script 'scripts/starters/setup-starter-node.ps1'.

    .DESCRIPTION
    Scaffolded from 'scripts/starters/setup-starter-node.ps1'. Review its container invocation mappings before publishing.
    ...
    $sourcePath = Join-Path $moduleRoot 'Scripts\starters\setup-starter-node.ps1'
