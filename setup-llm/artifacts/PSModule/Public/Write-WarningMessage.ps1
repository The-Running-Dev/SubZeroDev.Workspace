function Write-WarningMessage {
    ...
    if ($PSBoundParameters.ContainsKey('Message')) {
        $sourceParameters['Message'] = $Message
    }
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'Write-WarningMessage' -ErrorAction Stop
