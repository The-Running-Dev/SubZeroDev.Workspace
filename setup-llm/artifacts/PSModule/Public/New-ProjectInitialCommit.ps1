function New-ProjectInitialCommit {
    <#
    .SYNOPSIS
    Runs the discovered module command 'New-ProjectInitialCommit'.
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'New-ProjectInitialCommit' -ErrorAction Stop
