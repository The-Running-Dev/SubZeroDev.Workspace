...
```powershell
Invoke-SetupUbuntu [-Client <String>] [-SkipClaudeMem <switch>] [-SkipGitHub <switch>] [-SkipPlaywright <switch>] [-SkipGraphify <switch>] [-IncludeFilesystem <switch>] [-FilesystemPath <String[]>] [-IncludeDatabase <switch>] [-DatabaseName <String>] [-DatabaseCommand <String>] [-DatabaseArgument <String[]>] [<CommonParameters>]
```
