function New-AgentsInstructions {
    <#
    .SYNOPSIS
    Runs the discovered module command 'New-AgentsInstructions'.
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'New-AgentsInstructions' -ErrorAction Stop
