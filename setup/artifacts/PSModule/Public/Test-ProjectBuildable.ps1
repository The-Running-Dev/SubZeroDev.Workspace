function Test-ProjectBuildable {
    <#
    .SYNOPSIS
    Runs the discovered module command 'Test-ProjectBuildable'.
    ...
    if ($PSBoundParameters.ContainsKey('BuildCommand')) {
        $sourceParameters['BuildCommand'] = $BuildCommand
    }
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'Test-ProjectBuildable' -ErrorAction Stop
