function Test-CommandAvailable {
    <#
    .SYNOPSIS
    Runs the discovered module command 'Test-CommandAvailable'.
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'Test-CommandAvailable' -ErrorAction Stop
