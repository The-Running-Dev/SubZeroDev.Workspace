function Invoke-LanguageStarter {
    <#
    .SYNOPSIS
    Runs the discovered module command 'Invoke-LanguageStarter'.
    ...
    $sourceCommand = Get-Command -Module $sourceModule.Name -Name 'Invoke-LanguageStarter' -ErrorAction Stop
